...
AppendPathVariable -Path "$($env:USERPROFILE)\AppData\Local\Programs\WinMerge"
...
AppendPathVariable -Path "$($env:USERPROFILE)\OneDrive\Softs\Tools\SourceGit"
...
AppendPathVariable -Path "C:\Program Files\PuTTY\"
AppendPathVariable -Path "C:\Program Files\qemu"
AppendPathVariable -Path "C:\Program Files\Sublime Merge"
...
Add-MpPreference -ExclusionPath "E:\repos"
Add-MpPreference -ExclusionPath "F:\repos"
