...
- **Hugo** static site generator (`hugo.yaml`, theme: `theme` — a permanently forked copy of `hugo-xmin`, at the repo root via `themesDir: "."`)
...
theme/             # Hugo theme (forked hugo-xmin; provides body { max-width: 960px; margin: auto; })
