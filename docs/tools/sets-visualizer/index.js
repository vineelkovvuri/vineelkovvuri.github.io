(function () {
    ...
    var STORAGE_KEY = 'setsVisualizer.text';
    var DEFAULT_TEXT = [
    ...
    function loadSavedText() {
        try {
            ...
            return (saved !== null && saved.trim()) ? saved : DEFAULT_TEXT;
        } catch (e) {
            return DEFAULT_TEXT;
        }
    }
    ...
    function saveText() {
        if (!monacoEditor) return;
        try {
            localStorage.setItem(STORAGE_KEY, monacoEditor.getValue());
    ...
    require(['vs/editor/editor.main'], function () {
        ...
        // Persist editor text on every change
        monacoEditor.onDidChangeModelContent(saveText);
